...
<img src="./ProductionAssets/web/menu-bar-item-clean.png" title="Busy Light's menu bar item" alt="A macOS menu bar item. The menu bar says “🟡 Concentrating”. Below that is an open menu with a series of red, amber, green, and off emojis and settings names for a busy light, a dividing line, then on and off for webcam lights. Another dividing line, and then Help, Settings…, and Quit." width="50%"><img src="./ProductionAssets/web/busy-light-hardware.jpeg" title="A photo of the door-mounted Busy Light hardware" alt="A photo of the door-mounted Busy Light hardware. A clip comes over the top of the door, and a ring of LEDs is mounted beneath a 3D-printed diffuser. The ring of lights is lit up in an amber color, indicating that the office occupant is concentrating." width="50%">
...
⬇️ [Download the latest release now](https://github.com/swizzlevixen/busylight/releases/latest)
